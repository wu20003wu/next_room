    ...
    <section className="page-section" id="about">
        ...
        <ul className="timeline">
            ...
            <div className="timeline-panel">
                ...
                <h4>March 2024</h4>
                <h4 className="subheading">The Origins</h4>
                </div>
                <div className="timeline-body"><p className="text-muted">
                In 2024 I was 16 years old and went to the IMS, i.e. computer science middle school, in Zurich Hottingen and BZZ (Zurichsee Education Center).At that time I was very interested in business and finance
                    </p></div>
            </div>
            </li>
